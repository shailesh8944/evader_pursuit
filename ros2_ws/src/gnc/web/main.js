...
var ros = new ROSLIB.Ros({
  ...
  function processOdomMessages(message1, message2) {
    ...
    // Update all charts
    updatePathChart(x1, y1, x2, y2);
    updateSingleVariableChart(xPositionChart, x1, x2);
    updateSingleVariableChart(yPositionChart, y1, y2);
    updateSingleVariableChart(zPositionChart, z1, z2);
    updateSingleVariableChart(uVelocityChart, u1, u2);
    updateSingleVariableChart(vVelocityChart, v1, v2);
    updateSingleVariableChart(wVelocityChart, w1, w2);
    updateSingleVariableChart(rollChart, euler1.roll, euler2.roll);
    updateSingleVariableChart(pitchChart, euler1.pitch, euler2.pitch);
    updateSingleVariableChart(yawChart, euler1.yaw, euler2.yaw);
    updateSingleVariableChart(pAngularVelocityChart, p1, p2);
    updateSingleVariableChart(qAngularVelocityChart, q1, q2);
