...
interfaces__msg__DVL__init(interfaces__msg__DVL * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    interfaces__msg__DVL__fini(msg);
    return false;
  }
  // velocity
...
interfaces__msg__DVL__create()
{
  ...
  interfaces__msg__DVL * msg = (interfaces__msg__DVL *)allocator.allocate(sizeof(interfaces__msg__DVL), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__DVL));
  bool success = interfaces__msg__DVL__init(msg);
  if (!success) {
...
interfaces__msg__DVL__Sequence__init(interfaces__msg__DVL__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__DVL * data = NULL;

  if (size) {
    data = (interfaces__msg__DVL *)allocator.zero_allocate(size, sizeof(interfaces__msg__DVL), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__DVL__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__DVL__fini(&data[i - 1]);
      }
...
interfaces__msg__DVL__Sequence__fini(interfaces__msg__DVL__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__DVL__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__DVL__Sequence * array = (interfaces__msg__DVL__Sequence *)allocator.allocate(sizeof(interfaces__msg__DVL__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__DVL__Sequence__init(array, size);
  if (!success) {
...
interfaces__msg__DVL__Sequence__destroy(interfaces__msg__DVL__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces__msg__DVL__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interfaces__msg__DVL__Sequence__are_equal(const interfaces__msg__DVL__Sequence * lhs, const interfaces__msg__DVL__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__DVL__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__msg__DVL__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__DVL);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__msg__DVL * data =
      (interfaces__msg__DVL *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__DVL__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__msg__DVL__fini(&output->data[i]);
        }
        return false;
      }
    }
